    ...
    <div className='flex-col justify-between items-center  bg-white rounded-[19px]  pr-[4px] pl-[21px] pb-[47px] pt-0'>
      ...
      <div className='flex justify-between items-center cursor-pointer'>
        ...
        >
          ...
          <p className='text-[#757897] text-center  w-[207px] font-lato font-bold text-xs'>
        ...
        >
          ...
          <p className='text-[#757897] w-[207px] text-center font-lato font-bold text-xs'>
        ...
        <div className='flex flex-col items-center justify-between cursor-pointer'>
          <span
            className='font-lato font-bold text-8xl text-[#757897]'
            onClick={() => handlechange(100)}
          >
            3
          </span>
          <h5 className='font-lato font-bold text-xl text-[#757897]'>

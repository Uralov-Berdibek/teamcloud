    ...
    <div className='flex flex-col justify-between items-center gap-6 pb-12'>
      ...
      <div className='w-full flex flex-col justify-between items-start gap-16 border  border-[#757897] rounded-[15px] pt-[30px] pl-[43px] pr-[38px] pb-[40px]'>
          <div className='w-full flex justify-between items-start'>
               <div className='flex flex-col justify-between items-start gap-2'>
                  <h2 className='font-inter font-medium text-4xl'>Functions</h2>
                  <p className='font-inter font-extralight text-xl'>1 Lambda function 
                    actively running in production.</p>
                    <p className='font-inter font-extralight text-2xl'>Learn more about 
      ...
      <div className='w-full flex flex-col justify-between items-start gap-4 border  border-[#757897] rounded-[15px] px-1 pb-[63px]'>
        ...
        <div className='w-full pl-[38px] flex flex-col justify-between items-start gap-7'>
            <h3 className='font-lato font-medium text-3xl'>Add Log Drains</h3>
            <p className='w-[581px] font-lato font-medium text-xl text-[#9294AD]'>Use Log Drains to forward your site's function logs to third- party monitoring services
      ...
      <div className='w-full flex flex-col justify-between items-start gap-7 pt-5 pb-16 pl-14 border border-[#757897] rounded-[15px]'>
        <div className='w-2/5 px-6 py-1 flex justify-start items-center gap-1 rounded-[10px] border border-[#000000]'>
            <FiSearch className='w-7 h-7 text-[#757897]'/>
            <input type="text" placeholder=' Search by branch or Deploy Preview number' className='flex outline-none' />
        </div>
        <div className='flex flex-col justify-center items-start gap-1'>
            <h3 className='font-lato font-medium text-xl'>Next.js Server Handler <span className='font-lato font-medium text-xl text-[#9294AD]'>System</span></h3>
            <p className='font-lato font-medium text-xl text-[#9294AD]'>Created on Jul 28 (2 days ago)</p>
        </div>
      </div>
    </div>
  )

    ...
    <div className='w-full flex flex-col gap-12 pb-14'>
        ...
        <div className='w-full flex justify-between items-end'>
            <div className='flex flex-col items-start gap-1'>
                <h2 className='font-lato font-semibold text-3xl text-[#757897]'>All integrations</h2>
                <p className='font-lato font-semibold text-2xl text-[#757897]'>Integrations are a way to 
        ...
        <div className='flex justify-between items-center pt-6 pb-[68px] pl-9 pr-32 rounded-[10px] bg-[#EBF2FF]'>
            <div className='flex flex-col items-start gap-6'>
                <h2 className='w-[484px] font-inter font-bold text-3xl text-[#9294AD]'>Build deep integrations and 
        ...
        <div className='w-full flex flex-col items-start gap-8'>
            <div className='w-full flex justify-center items-center gap-7 py-3  pl-7 border border-[#000000] rounded-[10px]'>
                <Image width={36} height={36} src="/images/integration__search.svg" alt="Search" />
                <input type="text" placeholder='Search integrations' className='w-full outline-none' />
            </div>
